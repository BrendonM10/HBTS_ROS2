...
#            prefix=['xterm -e gdb --args'],
        ...
        executable="hbts_bridge_franka",
        name="hbts_bridge_franka",
        output="screen",
    	),
        
        Node(
        package='haptic_bilateral_teleoperation_system', 
        executable='sensor_calibration_franka',
        name='sensor_calibration_franka',
        output="screen",
    	),
        ...
        executable='relay',
        name='wrench_relay',
        arguments=['/franka_calibrated_sensor/wrench', '/cartesian_compliance_controller/ft_sensor_wrench'],
        output='screen'
    	),
        ...
        parameters=[
            {"omni_name": "phantom"},
            {"publish_rate": 1000},
            {"reference_frame": "panda_link0"},  # Publish poses in the "world" frame
            {"units": "mm"}
        ]
    	)
